...
public class AlbumView extends LinearLayout {
    ...
    private void init(final Context context) {
        ...
        LayoutInflater.from(context).inflate(com.zx.zxutils.R.layout.layout_camera_album, this);
        llReturn = findViewById(com.zx.zxutils.R.id.ll_album_return);
        llCommit = findViewById(com.zx.zxutils.R.id.ll_album_commit);
        rvAlbum = findViewById(com.zx.zxutils.R.id.rv_album);
