...
//        return (showCamera() && position == 0) ? ITEM_TYPE_CAMERA : ITEM_TYPE_PHOTO;
    ...
    public AlbumAdapter.PhotoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = inflater.inflate(com.zx.zxutils.R.layout.__picker_item_photo, parent, false);
    ...
    public void onBindViewHolder(final AlbumAdapter.PhotoViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == ITEM_TYPE_PHOTO) {
            ...
            holder.ivPhoto.setImageResource(com.zx.zxutils.R.drawable.__picker_camera);
        }
    }
    ...
    public static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoViewHolder(View itemView) {
            super(itemView);
            ivPhoto = (ImageView) itemView.findViewById(com.zx.zxutils.R.id.iv_photo);
            vSelected = itemView.findViewById(com.zx.zxutils.R.id.v_selected);
            cover = itemView.findViewById(com.zx.zxutils.R.id.cover);
        }
    }
